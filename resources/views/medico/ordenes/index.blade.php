    ...
    <div class="  mx-auto {{ $pageWrap }}">
        <section class="{{ $card }} p-5 sm:p-6">
            ...
            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                Consulta órdenes de laboratorio, imagen, procedimiento e interconsulta.
            </p>
        </section>

        <section class="{{ $card }} overflow-hidden">
            <div class="px-5 sm:px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-lg font-bold text-gray-900 dark:text-white">Listado de órdenes</h2>
            </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full">
                    <thead class="bg-gray-50 dark:bg-gray-800/50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-black uppercase tracking-[0.14em] text-gray-400 dark:text-gray-500">Orden</th>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @forelse($ordenes as $orden)
                            <tr class="hover:bg-gray-50/80 dark:hover:bg-gray-800/40 transition">
                                <td class="px-6 py-4">
                                    <div class="font-semibold text-gray-900 dark:text-white">{{ $orden->num_orden }}</div>
                                ...
                                <td class="px-6 py-4 text-right">
                                    <a href="{{ route('ordenes-medicas.show', $orden) }}"
